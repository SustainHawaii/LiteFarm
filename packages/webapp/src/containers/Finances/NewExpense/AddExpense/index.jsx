      ...
      <div className={defaultStyles.financesContainer}>
        ...
        <div>
          ...
          <div className={footerStyles.bottomContainer}>
            ...
            <div style={{cursor:'pointer',backgroundColor:'#41b0c0',height:'38px',width:'7rem',borderRadius:'12px',color:'white',justifyContent:'center',alignItems:'center',color:'white',display:'flex'}} onClick={() => this.handleSubmit()}>
